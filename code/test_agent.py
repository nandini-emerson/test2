...
from agent import ConcertTicketCollectionAssistantEditedAgent

class TestConcertTicketCollectionAssistantEditedAgent:
    
    @pytest.fixture
    def agent(self):
        return ConcertTicketCollectionAssistantEditedAgent()
